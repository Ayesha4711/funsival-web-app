        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="flex items-center gap-2 mb-4">
              <Image src={logo} alt="Funsival" width={130} height={40} className="h-9 w-auto" />
            </div>
          ...
          <div className="lg:w-2/3 grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Help Center', 'Cancellation Policy', 'Privacy Policy', "Terms & Conditions", "FAQ's", 'Report'].map(item => (
                  <li key={item}>
            ...
            {/* Hosting */}
            <div>
              <h3 className="text-base font-bold text-gray-900 mb-4">Hosting</h3>
              <ul className="space-y-3">
                {['Funsival your home', 'Hosting resources', 'Hosting Responsibility', 'Community Forum'].map(item => (
                  <li key={item}>
                    <Link href="#" className="text-sm text-gray-500 hover:text-gray-800 transition-colors">
                      {item}
                    </Link>
            ...
            {/* Funsival */}
            <div>
              <h3 className="text-base font-bold text-gray-900 mb-4">Funsival</h3>
              <ul className="space-y-3">
