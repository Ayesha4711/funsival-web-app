...
const timezones = [
  ...
  { value: "pk", label: "UTC+05:00 — Pakistan" },
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl px-5 py-5">
          ...
          <div className="space-y-3">
            ...
            <button className="flex items-center justify-between w-full text-left hover:bg-red-50 rounded-xl px-3 py-2.5 transition-colors group">
            ...
            <div className="flex items-center gap-2 shrink-0">
              {!acc.isDefault && (
                <button
                  ...
                  className="text-xs text-[var(--color-primary)] border border-[var(--color-primary)] rounded-lg px-2.5 py-1 hover:bg-[var(--color-primary)]/5 transition-colors"
                >
                  Set Default
                </button>
              )}
              <button className="p-1.5 text-gray-400 hover:text-[var(--color-primary)] hover:bg-gray-100 rounded-lg transition-colors">
                <EditIcon />
              </button>
              <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-6">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                onClick={addAccount}
                className="flex-1 bg-[var(--color-primary)] text-white text-sm font-semibold py-2.5 rounded-xl hover:opacity-90 transition-opacity"
              >
                Add Account
              </button>
            </div>
...
export default function SettingsPage() {
  ...
  const Panel = active?.panel ?? NotificationsTab;
