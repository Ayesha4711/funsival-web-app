...
const PlacesIllustration = () =>
  ...
  >
    ...
    <path
      d="M22 50L30 28L36 40L42 32L50 50H22Z"
      fill="#81C784"
      stroke="#4CAF50"
      strokeWidth="1.5"
    ...
    />
    <path
      d="M36 20C33 20 30 23 30 27C30 32 36 38 36 38C36 38 42 32 42 27C42 23 39 20 36 20Z"
      fill="#EF5350"
      stroke="#D32F2F"
      strokeWidth="1.5"
    />
...
const EquipmentIllustration = () =>
  ...
  >
    ...
    {/* Surfboard */}
    <path
      d="M52 18C52 18 58 24 56 32C54 40 50 38 50 38L44 28C44 28 46 20 52 18Z"
      fill="#FF8A65"
      stroke="#E64A19"
      strokeWidth="1.5"
    />
...
const ActivitiesIllustration = () =>
  ...
  >
    ...
    />
    <path
      d="M28 35C28 30 32 28 36 28C40 28 44 30 44 35V42H28V35Z"
      fill="#4DB6AC"
      stroke="#00897B"
      strokeWidth="1.5"
    />
    <path
      d="M28 42L26 52M44 42L46 52"
      stroke="#00897B"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M28 32L22 38M44 32L50 38"
      stroke="#00897B"
      strokeWidth="2"
      strokeLinecap="round"
    />
...
const ServicesIllustration = () =>
  ...
  >
    ...
    />
    <path
      d="M28 26V24C28 21 30 20 36 20C42 20 44 21 44 24V26"
      stroke="#8E24AA"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export default function StepCategory({ selected, onSelect, onNext }) {
  return (
    <div className="flex flex-col items-center pt-6 pb-10">
      ...
      <p className="text-sm text-[#475467] text-center max-w-lg mb-10 leading-relaxed">
